...
extern int send_number(char isHttps, char purpose, char phone);
#define GET_REQUEST \
    "GET / HTTP/1.1\r\n" \
    "Host: 192.168.2.125\r\n" \
    "Accept: text/html\r\n" \
...
int send_number(char isHttps, char purpose, char phone)
{
    char tmp1[100];
    char method = 0; //GET
    char contentType[] = "text/html";
	...
	mdelay(10);
		...
		printf("%s",domain);
		mdelay(10);
    strcpy(tmp1,"/smartbell/visitor?purpose=1&number=20100000&phone=20123456");
    mdelay(10);
		printf("\n\r");
