...
extern uint8_t DBGU_RxBuffer[DBGU_RX_BUFFER_SIZE];
extern uint32_t DBGU_RxBufferTail;
extern uint32_t DBGU_RxBufferHead;
extern int DBGU_InputReady;
extern int escape;

extern void Test_uart2(uint8_t ch);
